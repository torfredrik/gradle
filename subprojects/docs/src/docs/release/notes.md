...
Gradle now defines connection and socket timeouts for all HTTP requests. Please see [Configuring HTTP timeout](userguide/dependency_management.html#sec:http_timeout) for more details.
