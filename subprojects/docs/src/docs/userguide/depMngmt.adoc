...
Under certain conditions you may want to set timeout for HTTP requests. The following system properties can be used:
...
| Timeout in milliseconds when requesting a connection from the underlying connection manager.
